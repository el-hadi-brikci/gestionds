<div >
    <div class="tab">
        <ul class="nav nav-tabs customtab" role="tablist">
             ...
             <li class="nav-item">
                  <a  wire:click.prevent='selectTab("logo_favicon")' class="nav-link {{ $tab == 
                    'logo_favicon' ? 'active' : '' }}" data-toggle="tab" href="#logo_favicon" role="tab" 
                  aria-selected="false">Logo & favicon</a>
             </li>
             <li class="nav-item">
                  <a  wire:click.prevent='selectTab("social_networks")' class="nav-link {{ $tab == 
                    'social_networks' ? 'active' : '' }}" data-toggle="tab" href="#social_networks" role="tab" 
                  aria-selected="false">Social networks</a>
             </li>
             <li class="nav-item">
                  <a  wire:click.prevent='selectTab("payment_methodes")' class="nav-link {{ $tab == 
                    'payment_methodes' ? 'active' : '' }}" data-toggle="tab" href="#payment_methodes" role="tab" 
                  aria-selected="false">Payment methodes</a>
             </li>
        </ul>
               ...
               <div class="pd-20">
                   <div class="row">
                       <div class="col-md-6">
                           ...
                           <form action="{{route('adminchange-logo')}}" method="POST" enctype="multipart/form-data" id="change_site_logo_form">
                               @csrf
                               <div class="mb-2">
...
<form action="{{route('adminchange-favicon')}}" method="post" enctype="multipart/form-data" id="change_site_favicon_form">
                         @csrf
                         <div class="mb-2">
             ...
             <div class="tab-pane fade  {{ $tab == 'payment_methodes' ? 'active show' : '' }}" id="payment_methodes" role="tabpanel">
                  <div class="pd-20">
                       ------Payment methodes----
                  </div>
             </div>
